    ...
    return (
        ...
        <View style={{ flex: 1, backgroundColor: "#fff", paddingHorizontal: 20, paddingTop: 40 }}>
            ...
            <View style={{ backgroundColor: "#FAFAFA", padding: 10, marginTop: 15, borderRadius: 10 }}>
                ...
                <Pressable onPress={()=>{router.push("/driver/profile/setting")}} style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
                ...
                <Pressable onPress={()=>{router.push("/driver/profile/earnings")}} style={{ flexDirection: "row", alignItems: "center", gap: 10, marginTop: 15 }}>
                    <FontAwesome name="dollar" size={20} color="#F8BD00" />
                    <Text>Earnings</Text>
                </Pressable>


                <Pressable onPress={()=>{router.push("/driver/profile/about")}} style={{ flexDirection: "row", alignItems: "center", gap: 10, marginTop: 15 }}>
            ...
            {(!securityModel && !paymentModel) && (<BottomDriverNav />)}
                ...
                securityModel && (
                    <View style={{ position: "absolute", width: Dimensions.get("screen").width, height: Dimensions.get("screen").height, backgroundColor: 'rgba(0, 0, 0, 0.5)', justifyContent: "flex-end", alignItems: "flex-end" }}>
                        ...
                        <View style={{ backgroundColor: "#FFFFFF", padding: 20, width: Dimensions.get("screen").width, borderTopStartRadius: 30, height: 200, borderTopEndRadius: 30 }}>
                            ...
                            <Pressable onPress={() => router.push("/driver/profile/otp")} style={{ flexDirection: "row", alignItems: "center", gap: 10, marginTop: 20 }}>
