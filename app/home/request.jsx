...
const Request = () => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: "#fff", position: "relative" }}>
            ...
            <Modal onRequestClose={() => setRequestModel(false)} visible={requestModel} animationType="slide" transparent={true}>

                <Pressable onPress={() => setRequestModel(false)} style={{ flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
            ...
            <Modal onRequestClose={() => setPaymentModel(false)} visible={paymentModel} animationType="slide" transparent={true}>

                <Pressable onPress={() => setPaymentModel(false)} style={{ flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
            ...
            <Modal onRequestClose={() => setAddCreditCard(false)} visible={addCreditCard} animationType="slide" transparent={true}>

                <Pressable onPress={() => setAddCreditCard(false)} style={{ flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
